     ...
     <header className="flex justify-between bg-gray-500 items-center p-2 px-4 md:px-40">
          ...
          <nav className="hidden md:flex md:items-center">
            <ul className="flex text-sm md:text-xl">
              ...
              <li className="mx-3 border-b-2 border-white/[0] hover:border-white/[100]">
                <NavLink to="/myprofile" className={(navData) => navData.isActive ? "text-orange-500" : ""}>
                  My Profile
                </NavLink>
              </li>
            </ul>
          ...
          {/* Mobile Menu */}
          <ul id="mobile-menu" className="hidden md:hidden absolute z-10 top-16 left-0 bg-black w-full flex flex-col items-center">
